...
namespace RayJaysPizza.Migrations
{
    ...
    [Migration("20231013212724_excludeorderitems")]
    partial class excludeorderitems
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RayJaysPizza.Models.Items", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RayJaysPizza.Models.OrderItems", b =>
                {
                    b.HasOne("RayJaysPizza.Models.Items", "Item")
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RayJaysPizza.Models.Orders", "Order")
                        .WithMany()
